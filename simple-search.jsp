...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-md-8 job_search_div">
            ...
            <form action="simple-search.jsp" method="POST">
            ...
            <div class="row">
                <jsp:scriptlet>
                            ...
                            try
                            {
                                ...
                                PreparedStatement ps=con.prepareStatement("select * from jobs where job_profile LIKE '%"+technology2+"%' AND location LIKE '%"+location2+"%'");
                ...
                <div class="col-md-12 display_job_div">
                    ...
                    <span class="fa fa-home"></span> <span style="color: #9f9d9d"> Company : </span> <jsp:expression>company</jsp:expression> </span> <br>
                    ...
                    <br><a href="job-des.jsp?jid=<jsp:expression>id</jsp:expression>"> See Full Details </a>
                </div>
